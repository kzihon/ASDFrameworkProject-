...
public class PersonalAccountController implements IController {
	...
	public void add(IView viewSender) {
		try {
			...
			if(oldCustomer) {
				...
				customer = customerFactory.createPerson(customerName, birthdateValue, street, city, state, zip, email);
			}
