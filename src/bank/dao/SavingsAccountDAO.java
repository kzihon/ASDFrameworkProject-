...
public class SavingsAccountDAO implements DAO {
    ...
    public void persist(IModel model) {
        ...
        try {
            ...
            SavingsAccount account = (SavingsAccount)model;
            ...
            if(account.getCustomer() instanceof Person) {
                ...
                if(person.getId() == 0) {
                    ...
                    accountStatement.setString(3, SAVINGS);
                    ...
                    accountStatement.setString(4, SAVINGS);
    ...
    public IModel getById(int id) {
        try {
            String sql = SqlRequestConstants.SELECT_ACCOUNT_BY_ID + id + " AND acc.account_type = '" + SAVINGS + "'";

            CustomerFactory customerFactory = new CustomerFactory();
            SavingsAccountFactory factory = (SavingsAccountFactory)SimpleAccountFactory.getSavingsAccountFactory();
            ...
            while(rs.next()) {
                ...
                SavingsAccount account = (SavingsAccount) factory.createAccount(customer, accNum);
                account.setId(accId);
    ...
    public List<IModel> getAll() {
        try {
            ...
            String sql = SqlRequestConstants.ALL_ACCOUNTS + "'" + SAVINGS + "'";
    ...
    public void delete(IModel model) {
        try {
            SavingsAccount account = (SavingsAccount) model;
            String sql = SqlRequestConstants.DELETE_ACCOUNT + account.getId() + " AND account_type = '" + SAVINGS + "'";
