...
public class DepositController implements IController {
    ...
    public void add(IView viewSender) {
        try {
            ...
            ccard.makeWithdrawal(amountValue, operation);
            ccard.save();

            JOptionPane.showMessageDialog(null, "A deposit of " + amountValue + " have successfuly been done for " + ccard.getCustomer().getName() + "'s credit-card!", "Information: Success", JOptionPane.INFORMATION_MESSAGE);
            sender.dispose();
