...
public class GoldCCardDAO implements DAO {
    ...
    public void persist(IModel model) {
        ...
        try {
            ...
            if(person.getId() == 0) {
                ...
                ccardStatement.setString(3, GOLD);
                ...
                ccardStatement.setString(4, GOLD);
    ...
    public IModel getById(int id) {
        try {
            String sql = SqlRequestConstants.SELECT_CREDITCARD_BY_ID + id + " AND cc.cctype = '" + GOLD + "'";
            ...
            CCardFactory factory = SimpleCCardFactory.getGoldCCardFactory();
    ...
    public List<IModel> getAll() {
        try {
            ...
            String sql = SqlRequestConstants.ALL_CREDITCARDS + " AND cc.cctype = '" + GOLD + "'";
    ...
    static public IModel getCCardByNumber(String accountNumber) {
        try {
            ...
            PreparedStatement statement = connection.prepareStatement(
                    SqlRequestConstants.SELECT_CREDITCARD_BY_ACCOUNT_NUMBER + " AND cc.cctype = '" + GOLD + "'");
